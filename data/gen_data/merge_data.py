...
# @File    : merge_data.py
# @Software: PyCharm
# @Brief   : 将旧的数据集使用 yolov5 检测人体，合入已有的头盔标签
# 使用命令 python detect.py --save-txt --source 图片路径， 可以在 output 中看到每个图片的 txt 标签文件

import os

YOLOV5_LABEL_ROOT = f"E:\AI_Project\Smart_Construction_Project\inference\output\\"
DATASET_LABEL_ROOT = f"E:\AI_Project\AI_Learning\Dataset\VOC2028\Labels\\"
